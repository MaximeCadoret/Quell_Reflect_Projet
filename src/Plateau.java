...
public class Plateau {
	...
	public int nombrePiece; // donne le nombre de pièce
	...
	public Plateau(int num) {
		...
		// Pour le moment j'ai considéré 2 paires d'anneaux et un type
		// d'interrupteur.
		...
		// Le problème c'est qu'il faut gérer les aspects statiques et pas
		// statiques...
		...
		niveau = num;
		 ...
		 int[] coordA1 = null;
		 int[] coordA2 = null;
		 int ligne = 0; // C'est la ligne qui va être lue. Initialiser à zéro car
		// les preières cases des tableaux Java sont à 0
		 ...
		 //voir les problèmes auxquels nous sommes confrontés pour savoir exactement
	...
	public void restartPlateau() {
		// Gérer la réinitialisation des pièces, en fonction de leur
